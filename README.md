## Project Overview
<img width="1039" height="670" alt="image" src="https://github.com/user-attachments/assets/ff98ea61-29f5-49cd-9233-81b88ba08c68" />
...
- OCR 방법 교체 ( YoLo v8 -> deepseek OCR 모델로 교체 시도), Figure와 Caption이 같이 담겨야, Agent가 Figure에 있는 지표들과 본문에 있는 내용을 연결 가능.
- 동지시어(coreference) 추출 자동화 및 단어 및 단위 표준화
